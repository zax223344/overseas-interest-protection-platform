...
(function () {
  ...
  function _normLevel(item) {
    ...
    var RED_RE = /中国公民[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持|被枪杀|被击毙|被杀害)|中方人员[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持)|华人[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持)|华侨[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持)|华裔[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持)|中国留学生[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持)|中国工人[^，。；;]{0,20}(?:被袭|遭袭|受袭|遇袭|被绑|遭绑架|被绑架|遭劫持|被劫持)|撤侨|撤离[^，。；;]{0,20}中国公民|遣返[^，。；;]{0,20}中国公民|群体开枪|大规模枪击|中国公民[^，。；;]{0,20}枪击|中方人员[^，。；;]{0,20}枪击|华人[^，。；;]{0,20}枪击|华侨[^，。；;]{0,20}枪击|华裔[^，。；;]{0,20}枪击/i;
