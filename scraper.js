...
var COLLECTED_DB={
  ...
  CATEGORIES:[
    /* 分类体系 v2.0（#627，2026-09-05）：18 事件子类；写路径经 DBCenter._coerceCol 归一 */
    'terror_events','military_conflicts','mass_violence','crime_events',
    'regime_change','election_events','geopolitical_intel','policy_shift',
    'sanctions_data','financial_market','business_climate',
    'social_unrest','public_health','cyber_security','industrial_accident','environmental_event',
    'natural_disasters','infrastructure',
    /* 退役旧 key 兼容（迁移后为空，读路径保留） */
    'security_events','political_events','osint_intel','economic_risk','legal_compliance'
  ],
...
var RISK_FUSION={
  ...
  fuse(){
    ...
    var events=[];
    /* 分类体系 v2.0：CATV2（app.js 注入）为源，兜底旧列表（scraper.js 先于 app.js 加载） */
    var categories=(typeof CATV2!=='undefined'&&CATV2.keys)?CATV2.keys.concat(['security_events','political_events','osint_intel','economic_risk','legal_compliance']):['terror_events','security_events','military_conflicts','political_events','natural_disasters','public_health','sanctions_data','social_unrest','infrastructure','geopolitical_intel','osint_intel'];
