...
var COLLECTED_DB={
  ...
  _syncAPI(k,v){if(typeof APIClient!=='undefined'&&APIClient.isOnline()){APIClient.saveCollected(k,v).catch(function(){});}},
...
var ENTERPRISE_DB={
  ...
  _syncAPI(v){if(typeof APIClient!=='undefined'&&APIClient.isOnline()){APIClient.saveEnterpriseProjects(v).catch(function(){});}},
...
var RISK_FUSION={
  ...
  _r(){try{return JSON.parse(localStorage.getItem(this.KEY)||'[]');}catch(e){return[];}},
  _w(v){try{localStorage.setItem(this.KEY,JSON.stringify(v));}catch(e){}this._syncAPI(v);},
  _syncAPI(v){if(typeof APIClient!=='undefined'&&APIClient.isOnline()){APIClient.saveRiskFusion(v).catch(function(){});}},
...
var THREAT_ORGS_DB={
  ...
  _syncAPI(all){if(typeof APIClient!=='undefined'&&APIClient.isOnline()){APIClient.saveThreatOrgs(all).catch(function(){});}},
