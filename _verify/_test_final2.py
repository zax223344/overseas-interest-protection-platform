...
async def main():
    async with async_playwright() as p:
        ...
        await page.wait_for_selector("#view-situation", state="visible", timeout=30000)
        ...
        await page.screenshot(path="C:/Users/28737/Desktop/新建文件夹/_verify/_screenshot_final2.png")
        await browser.close()
