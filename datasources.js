...
var DATASOURCES = (function(){
  ...
  var REGISTRY = [
    /* 官方权威 */
    {id:'DS-OF-01',name:'外交部领事司',cat:'official',icon:'🏛️',desc:'领事提醒/安全预警/撤侨通告',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','智能预警中心']},
    {id:'DS-OF-02',name:'领事直通车',cat:'official',icon:'🏛️',desc:'海外安全提醒推送',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','全域态势感知']},
    {id:'DS-OF-03',name:'商务部对外投资',cat:'official',icon:'🏛️',desc:'国别投资经营障碍报告',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','企业资产']},
    {id:'DS-OF-04',name:'应急管理部',cat:'official',icon:'🏛️',desc:'自然灾害/事故灾难通报',coverage:['全球'],cycle:60,rel:'A2',feeds:['disaster_events','实时风险监测']},
    /* 国际组织 */
    {id:'DS-IN-01',name:'联合国OCHA',cat:'intl',icon:'🌐',desc:'人道主义危机通报',coverage:['非洲','中东','南亚'],cycle:60,rel:'A2',feeds:['humanitarian','全域态势感知']},
    {id:'DS-IN-02',name:'世界银行数据',cat:'intl',icon:'🌐',desc:'国别经济指标/债务数据',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','预测分析']},
    {id:'DS-IN-03',name:'国际危机组织ICG',cat:'intl',icon:'🌐',desc:'冲突预警月报/危机追踪',coverage:['非洲','中东','南亚','拉美'],cycle:60,rel:'B1',feeds:['conflict_warning','威胁组织图谱']},
    {id:'DS-IN-04',name:'WHO疫情通报',cat:'intl',icon:'🌐',desc:'突发公共卫生事件',coverage:['全球'],cycle:60,rel:'A2',feeds:['health_events','实时风险监测']},
    /* 开源情报 OSINT */
    {id:'DS-OS-01',name:'GDELT全球事件库',cat:'osint',icon:'📡',desc:'全球媒体事件实时流(15分钟级)',coverage:['全球'],cycle:60,rel:'B2',feeds:['osint_intel','全域态势感知']},
    {id:'DS-OS-02',name:'ACLED武装冲突库',cat:'osint',icon:'📡',desc:'武装冲突/政治暴力事件定位',coverage:['非洲','中东','南亚'],cycle:60,rel:'B1',feeds:['conflict_events','威胁组织图谱']},
    {id:'DS-OS-03',name:'GTD恐怖主义数据库',cat:'osint',icon:'📡',desc:'恐袭事件结构化档案',coverage:['全球'],cycle:60,rel:'B1',feeds:['terror_events','威胁组织图谱']},
    {id:'DS-OS-04',name:'LiveUAMap',cat:'osint',icon:'📡',desc:'冲突地图实时标注',coverage:['中东','东欧','非洲'],cycle:60,rel:'B2',feeds:['conflict_events','全域态势感知']},
    {id:'DS-OS-05',name:'ReliefWeb',cat:'osint',icon:'📡',desc:'灾害与危机响应信息',coverage:['全球'],cycle:60,rel:'B1',feeds:['disaster_events','实时风险监测']},
    /* 新闻媒体 */
    {id:'DS-ME-01',name:'新华社国际频道',cat:'media',icon:'📰',desc:'国际时政要闻',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','全域态势感知']},
    {id:'DS-ME-02',name:'人民网国际',cat:'media',icon:'📰',desc:'华人华侨安全动态',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','智能预警中心']},
    {id:'DS-ME-03',name:'路透社',cat:'media',icon:'📰',desc:'突发事件快讯',coverage:['全球'],cycle:60,rel:'B1',feeds:['news_intel','全域态势感知']},
    {id:'DS-ME-04',name:'半岛电视台',cat:'media',icon:'📰',desc:'中东北非地区深度报道',coverage:['中东','非洲'],cycle:60,rel:'B2',feeds:['news_intel','实时风险监测']},
    /* 社交监测 */
    {id:'DS-SO-00',name:'微信公众号监测',cat:'social',icon:'📮',desc:'20个开源情报/安全核心公众号轮巡采集(每轮10个)',coverage:['全球'],cycle:15,rel:'A1',feeds:['osint_intel','智能预警中心'],realKey:'wechat_oa'},
    {id:'DS-SO-01',name:'X平台热点监测',cat:'social',icon:'💬',desc:'涉华涉企话题/突发目击信息',coverage:['全球'],cycle:60,rel:'C2',feeds:['social_monitor','自动预警']},
    {id:'DS-SO-02',name:'Telegram频道监测',cat:'social',icon:'💬',desc:'武装组织宣示/地区频道',coverage:['中东','东欧','南亚'],cycle:60,rel:'C1',feeds:['social_monitor','威胁组织图谱']},
    {id:'DS-SO-03',name:'当地社区论坛',cat:'social',icon:'💬',desc:'驻在国治安舆情',coverage:['非洲','东南亚','拉美'],cycle:60,rel:'C3',feeds:['social_monitor','实时风险监测']},
    /* 商业数据 */
    {id:'DS-CO-01',name:'航运AIS数据',cat:'commercial',icon:'💼',desc:'船舶定位/航线偏离监测',coverage:['红海','马六甲','几内亚湾'],cycle:60,rel:'B1',feeds:['shipping_monitor','实时风险监测']},
    ...
    {id:'DS-CO-04',name:'保险风险费率',cat:'commercial',icon:'💼',desc:'战争险/绑架赎金险费率异动',coverage:['高危国家'],cycle:60,rel:'B2',feeds:['economic_risks','智能预警中心']},
    /* 合作哨点 */
    {id:'DS-SE-01',name:'驻外企业安全员',cat:'sentinel',icon:'🎖️',desc:'一线安全员每日情况上报',coverage:['项目所在国'],cycle:60,rel:'A1',feeds:['sentinel_report','智能预警中心']},
    {id:'DS-SE-02',name:'使领馆安全通报',cat:'sentinel',icon:'🎖️',desc:'驻在国使领馆内部通报',coverage:['全球'],cycle:60,rel:'A1',feeds:['sentinel_report','全域态势感知']},
    {id:'DS-SE-03',name:'安保公司驻地报告',cat:'sentinel',icon:'🎖️',desc:'国际安保公司态势周报',coverage:['高危国家'],cycle:60,rel:'B1',feeds:['sentinel_report','威胁组织图谱']},
    {id:'DS-SE-04',name:'华人社团信息员',cat:'sentinel',icon:'🎖️',desc:'侨团治安信息网络',coverage:['东南亚','非洲','拉美'],cycle:60,rel:'C1',feeds:['sentinel_report','实时风险监测']},

    /* ===== 扩充开源数据源 v2.0（重点扩 OSINT 开源情报） ===== */
    /* 官方权威 增补 */
    {id:'DS-OF-05',name:'国家移民管理局',cat:'official',icon:'🏛️',desc:'出入境管控/边检预警',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','实时风险监测']},
    {id:'DS-OF-06',name:'海关总署',cat:'official',icon:'🏛️',desc:'进出口管制/贸易风险通报',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','企业资产']},
    {id:'DS-OF-07',name:'中国地震台网',cat:'official',icon:'🏛️',desc:'境外地震速报',coverage:['全球'],cycle:60,rel:'A1',feeds:['disaster_events','实时风险监测']},
    /* 国际组织 增补 */
    {id:'DS-IN-05',name:'国际货币基金组织IMF',cat:'intl',icon:'🌐',desc:'主权债务/金融稳定评估',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','预测分析']},
    {id:'DS-IN-06',name:'红十字会红新月会IFRC',cat:'intl',icon:'🌐',desc:'灾害应急/人道救援通报',coverage:['非洲','中东','南亚'],cycle:60,rel:'A2',feeds:['humanitarian','全域态势感知']},
    {id:'DS-IN-07',name:'国际民航组织ICAO',cat:'intl',icon:'🌐',desc:'空域安全/航路风险通告',coverage:['全球'],cycle:60,rel:'A2',feeds:['shipping_monitor','实时风险监测']},
    /* 开源情报 OSINT 大规模扩充 */
    {id:'DS-OS-06',name:'NASA FIRMS火点监测',cat:'osint',icon:'📡',desc:'卫星火点(冲突/爆炸/火灾)近实时',coverage:['全球'],cycle:60,rel:'B1',feeds:['disaster_events','实时风险监测']},
    {id:'DS-OS-07',name:'FlightRadar24航班追踪',cat:'osint',icon:'📡',desc:'军机/撤侨/异常航班ADS-B追踪',coverage:['全球'],cycle:60,rel:'B2',feeds:['shipping_monitor','全域态势感知']},
    {id:'DS-OS-08',name:'GDACS全球灾害预警',cat:'osint',icon:'📡',desc:'地震/飓风/洪水联合预警',coverage:['全球'],cycle:60,rel:'A2',feeds:['disaster_events','实时风险监测']},
    {id:'DS-OS-09',name:'USGS地震监测',cat:'osint',icon:'📡',desc:'全球地震速报(分钟级)',coverage:['全球'],cycle:60,rel:'A1',feeds:['disaster_events','实时风险监测']},
    {id:'DS-OS-10',name:'FEWS NET粮食安全',cat:'osint',icon:'📡',desc:'饥荒/粮食危机早期预警',coverage:['非洲','中东','南亚'],cycle:60,rel:'B1',feeds:['humanitarian','实时风险监测']},
    {id:'DS-OS-11',name:'IOM DTM流离失所追踪',cat:'osint',icon:'📡',desc:'难民/境内流离失所流动监测',coverage:['非洲','中东','南亚'],cycle:60,rel:'B1',feeds:['humanitarian','威胁组织图谱']},
    {id:'DS-OS-12',name:'UNHCR难民署数据',cat:'osint',icon:'📡',desc:'难民潮/庇护数据',coverage:['全球'],cycle:60,rel:'A2',feeds:['humanitarian','全域态势感知']},
    {id:'DS-OS-13',name:'NetBlocks网络中断',cat:'osint',icon:'📡',desc:'互联网封锁/断网(政局动荡信号)',coverage:['全球'],cycle:60,rel:'B1',feeds:['social_monitor','自动预警']},
    {id:'DS-OS-14',name:'Bellingcat开源调查',cat:'osint',icon:'📡',desc:'冲突事件开源核实/影像定位',coverage:['中东','东欧','非洲'],cycle:60,rel:'B1',feeds:['conflict_events','威胁组织图谱']},
    {id:'DS-OS-15',name:'HealthMap疫情监测',cat:'osint',icon:'📡',desc:'传染病暴发实时地图',coverage:['全球'],cycle:60,rel:'B1',feeds:['health_events','实时风险监测']},
    ...
    {id:'DS-OS-18',name:'InSight Crime有组织犯罪',cat:'osint',icon:'📡',desc:'拉美有组织犯罪/绑架勒索',coverage:['拉美'],cycle:60,rel:'B1',feeds:['conflict_events','威胁组织图谱']},
    {id:'DS-OS-19',name:'哨兵卫星影像',cat:'osint',icon:'📡',desc:'Sentinel-2地表变化监测',coverage:['全球'],cycle:60,rel:'B1',feeds:['osint_intel','实时风险监测']},
    ...
    {id:'DS-OS-22',name:'Crisis24风险预警',cat:'osint',icon:'📡',desc:'全球风险事件分级推送',coverage:['全球'],cycle:60,rel:'B1',feeds:['conflict_warning','智能预警中心']},
    {id:'DS-OS-23',name:'谷歌趋势舆情',cat:'osint',icon:'📡',desc:'涉华涉企搜索热度异动',coverage:['全球'],cycle:60,rel:'C2',feeds:['social_monitor','自动预警']},
    /* 新闻媒体 增补 */
    {id:'DS-ME-05',name:'CGTN国际频道',cat:'media',icon:'📰',desc:'中国视角国际新闻',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','全域态势感知']},
    {id:'DS-ME-06',name:'BBC监控',cat:'media',icon:'📰',desc:'全球媒体监测/译编',coverage:['全球'],cycle:60,rel:'B1',feeds:['news_intel','实时风险监测']},
    {id:'DS-ME-07',name:'法新社AFP',cat:'media',icon:'📰',desc:'突发快讯(中东/非洲)',coverage:['中东','非洲'],cycle:60,rel:'B1',feeds:['news_intel','全域态势感知']},
    {id:'DS-ME-08',name:'凤凰卫视资讯',cat:'media',icon:'📰',desc:'华人视角国际突发事件',coverage:['全球'],cycle:60,rel:'B2',feeds:['news_intel','智能预警中心']},
    /* 社交监测 增补 */
    {id:'DS-SO-04',name:'微博国际舆情',cat:'social',icon:'💬',desc:'涉海外安全话题热度',coverage:['全球'],cycle:60,rel:'C2',feeds:['social_monitor','自动预警']},
    {id:'DS-SO-05',name:'Facebook公共主页',cat:'social',icon:'💬',desc:'驻在国公共事件/抗议召集',coverage:['非洲','东南亚','拉美'],cycle:60,rel:'C3',feeds:['social_monitor','实时风险监测']},
    {id:'DS-SO-06',name:'Reddit相关板块',cat:'social',icon:'💬',desc:'地区冲突/治安讨论串',coverage:['全球'],cycle:60,rel:'C3',feeds:['social_monitor','实时风险监测']},
    ...
    {id:'DS-CO-08',name:'跨境资金流动监测',cat:'commercial',icon:'💼',desc:'资本外逃/汇率异常',coverage:['高危国家'],cycle:60,rel:'B1',feeds:['economic_risks','智能预警中心']},
    /* 合作哨点 增补 */
    {id:'DS-SE-05',name:'中资企业商会',cat:'sentinel',icon:'🎖️',desc:'海外商会安全联防通报',coverage:['全球'],cycle:60,rel:'B1',feeds:['sentinel_report','智能预警中心']},
    {id:'DS-SE-06',name:'国际SOS救援',cat:'sentinel',icon:'🎖️',desc:'医疗救援/安全撤离服务',coverage:['全球'],cycle:60,rel:'A2',feeds:['sentinel_report','实时风险监测']},
    {id:'DS-SE-07',name:'Control Risks',cat:'sentinel',icon:'🎖️',desc:'国际风险咨询态势评估',coverage:['高危国家'],cycle:60,rel:'B1',feeds:['sentinel_report','威胁组织图谱']},
    ...
    {id:'DS-OF-09',name:'国家反恐办',cat:'official',icon:'🏛️',desc:'境内外反恐预警通报',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','威胁组织图谱']},
    {id:'DS-OF-10',name:'发改委外资司',cat:'official',icon:'🏛️',desc:'海外投资安全国别指南',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','预测分析']},
    /* 国际组织 增补 */
    {id:'DS-IN-08',name:'国际刑警组织INTERPOL',cat:'intl',icon:'🌐',desc:'跨境犯罪/恐怖融资通报',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','威胁组织图谱']},
    {id:'DS-IN-09',name:'联合国安理会',cat:'intl',icon:'🌐',desc:'制裁决议/局势公报',coverage:['全球'],cycle:60,rel:'A1',feeds:['geopolitical','智能预警中心']},
    {id:'DS-IN-10',name:'国际移民组织IOM',cat:'intl',icon:'🌐',desc:'移徙/人口流动监测',coverage:['非洲','中东','拉美'],cycle:60,rel:'A2',feeds:['humanitarian','实时风险监测']},
    {id:'DS-IN-11',name:'联合国开发计划署UNDP',cat:'intl',icon:'🌐',desc:'脆弱国家风险评估',coverage:['非洲','南亚'],cycle:60,rel:'A2',feeds:['economic_risks','预测分析']},
    {id:'DS-IN-12',name:'欧盟对外行动署EEAS',cat:'intl',icon:'🌐',desc:'欧盟共同安全暨防务简报',coverage:['全球'],cycle:60,rel:'A2',feeds:['geopolitical','实时风险监测']},
    /* 开源情报 OSINT 大规模扩充 */
    {id:'DS-OS-24',name:'维基解密Wikileaks',cat:'osint',icon:'📡',desc:'泄露文档/内部通报',coverage:['全球'],cycle:60,rel:'C2',feeds:['osint_intel','威胁组织图谱']},
    {id:'DS-OS-25',name:'Planet卫星影像',cat:'osint',icon:'📡',desc:'每日重访地表变化监测',coverage:['全球'],cycle:60,rel:'B1',feeds:['osint_intel','实时风险监测']},
    {id:'DS-OS-26',name:'Maxar卫星',cat:'osint',icon:'📡',desc:'高分辨率冲突区域成像',coverage:['中东','东欧','非洲'],cycle:60,rel:'B1',feeds:['osint_intel','全域态势感知']},
    {id:'DS-OS-27',name:'全球和平指数GPI',cat:'osint',icon:'📡',desc:'国家和平/安全年度评级',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','预测分析']},
    {id:'DS-OS-28',name:'经济与和平研究所IEP',cat:'osint',icon:'📡',desc:'全球恐怖主义指数GTI',coverage:['全球'],cycle:60,rel:'A2',feeds:['terror_events','威胁组织图谱']},
    {id:'DS-OS-29',name:'透明国际腐败感知',cat:'osint',icon:'📡',desc:'腐败风险(投资环境)',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','企业资产']},
    {id:'DS-OS-30',name:'航空安全网络ASN',cat:'osint',icon:'📡',desc:'空难/航空事故数据库',coverage:['全球'],cycle:60,rel:'B1',feeds:['disaster_events','实时风险监测']},
    {id:'DS-OS-31',name:'海事安全中心MSCC',cat:'osint',icon:'📡',desc:'海盗/海上武装劫持预警',coverage:['红海','几内亚湾','马六甲'],cycle:60,rel:'B1',feeds:['shipping_monitor','实时风险监测']},
    {id:'DS-OS-32',name:'国际商会海盗报告',cat:'osint',icon:'📡',desc:'全球海盗事件周报',coverage:['全球'],cycle:60,rel:'B1',feeds:['shipping_monitor','智能预警中心']},
    ...
    {id:'DS-OS-35',name:'全球选举观察',cat:'osint',icon:'📡',desc:'选举暴力/政治动荡预警',coverage:['非洲','拉美','南亚'],cycle:60,rel:'B1',feeds:['political_events','实时风险监测']},
    {id:'DS-OS-36',name:'全球供应链压力指数',cat:'osint',icon:'📡',desc:'GSCPI供应链中断预警',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','预测分析']},
    /* 新闻媒体 增补 */
    {id:'DS-ME-09',name:'央视新闻国际',cat:'media',icon:'📰',desc:'中国视角国际要闻',coverage:['全球'],cycle:60,rel:'A1',feeds:['news_intel','全域态势感知']},
    {id:'DS-ME-10',name:'环球时报',cat:'media',icon:'📰',desc:'国际时政深度/涉华',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','智能预警中心']},
    {id:'DS-ME-11',name:'联合早报',cat:'media',icon:'📰',desc:'东南亚/中国周边观察',coverage:['东南亚','东亚'],cycle:60,rel:'B1',feeds:['news_intel','实时风险监测']},
    ...
    {id:'DS-SO-09',name:'微信/公众号舆情',cat:'social',icon:'💬',desc:'涉海外安全话题聚合',coverage:['全球'],cycle:60,rel:'C2',feeds:['social_monitor','实时风险监测']},
    {id:'DS-SO-10',name:'Gab/Parler',cat:'social',icon:'💬',desc:'极右/武装组织宣示',coverage:['欧美'],cycle:60,rel:'C1',feeds:['social_monitor','威胁组织图谱']},
    {id:'DS-SO-11',name:'Discord频道监测',cat:'social',icon:'💬',desc:'极端组织招募/宣示',coverage:['全球'],cycle:60,rel:'C1',feeds:['social_monitor','威胁组织图谱']},
    {id:'DS-SO-12',name:'小红书海外',cat:'social',icon:'💬',desc:'华人海外安全经验分享',coverage:['东南亚','欧美'],cycle:60,rel:'C3',feeds:['social_monitor','实时风险监测']},
    /* 商业数据 增补 */
    ...
    /* 合作哨点 增补 */
    {id:'DS-SE-08',name:'中资安保协会',cat:'sentinel',icon:'🎖️',desc:'海外安保行业态势共享',coverage:['非洲','中东','东南亚'],cycle:60,rel:'B1',feeds:['sentinel_report','威胁组织图谱']},
    {id:'DS-SE-09',name:'无国界医生MSF',cat:'sentinel',icon:'🎖️',desc:'冲突区医疗人道通报',coverage:['非洲','中东'],cycle:60,rel:'A2',feeds:['sentinel_report','实时风险监测']},

    /* ===== 大规模扩充 v5.0（聚焦海外利益安全 / 涉华，总数达131源） ===== */
    /* 官方权威 · 涉华 */
    {id:'DS-OF-11',name:'公安部境外安保局',cat:'official',icon:'🏛️',desc:'境外中国公民安全/撤侨协调',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','智能预警中心']},
    {id:'DS-OF-12',name:'国资委境外投资监管',cat:'official',icon:'🏛️',desc:'中资企业境外投资安全督导',coverage:['全球'],cycle:60,rel:'A2',feeds:['economic_risks','企业资产']},
    {id:'DS-OF-13',name:'驻外使领馆安保专报',cat:'official',icon:'🏛️',desc:'使领馆辖区安全形势日报',coverage:['全球'],cycle:60,rel:'A1',feeds:['sentinel_report','全域态势感知']},
    /* 国际组织 · 涉华 */
    {id:'DS-IN-13',name:'联合国人权理事会涉华',cat:'intl',icon:'🌐',desc:'涉华人权审议/特别报告员',coverage:['全球'],cycle:60,rel:'B2',feeds:['political_events','实时风险监测']},
    {id:'DS-IN-14',name:'国际特赦涉华观察',cat:'intl',icon:'🌐',desc:'涉华安全/拘押事件监测',coverage:['全球'],cycle:60,rel:'C2',feeds:['security_events','威胁组织图谱']},
    ...
    {id:'DS-OS-40',name:'南海局势监测',cat:'osint',icon:'📡',desc:'南海岛礁/航行安全动态',coverage:['南海','东南亚'],cycle:60,rel:'B1',feeds:['geopolitical','智能预警中心']},
    {id:'DS-OS-41',name:'台海局势监测',cat:'osint',icon:'📡',desc:'台海周边安全动态',coverage:['台海','东亚'],cycle:60,rel:'B1',feeds:['geopolitical','智能预警中心']},
    {id:'DS-OS-42',name:'中美关系动态',cat:'osint',icon:'📡',desc:'中美博弈/科技脱钩预警',coverage:['全球'],cycle:60,rel:'B1',feeds:['geopolitical','预测分析']},
    {id:'DS-OS-43',name:'华人安全事件库',cat:'osint',icon:'📡',desc:'海外华人遇袭/绑架事件归集',coverage:['全球'],cycle:60,rel:'B1',feeds:['security_events','威胁组织图谱']},
    {id:'DS-OS-44',name:'中资项目风险地图',cat:'osint',icon:'📡',desc:'海外中资项目风险点标注',coverage:['非洲','东南亚','南亚','拉美'],cycle:60,rel:'B1',feeds:['osint_intel','企业资产']},
    {id:'DS-OS-45',name:'涉华英文媒体监测',cat:'osint',icon:'📡',desc:'路透/彭博/FT涉华报道聚合',coverage:['全球'],cycle:60,rel:'B1',feeds:['news_intel','实时风险监测']},
    {id:'DS-OS-46',name:'使馆安全通告聚合',cat:'osint',icon:'📡',desc:'各使领馆安全提醒汇总',coverage:['全球'],cycle:60,rel:'A1',feeds:['security_events','智能预警中心']},
    /* 新闻媒体 · 涉华 */
    {id:'DS-ME-13',name:'中国日报CHINADAILY',cat:'media',icon:'📰',desc:'中国官方英文国际报道',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','全域态势感知']},
    {id:'DS-ME-14',name:'环球网国际',cat:'media',icon:'📰',desc:'涉华国际热点/深度',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','智能预警中心']},
    {id:'DS-ME-15',name:'海外网',cat:'media',icon:'📰',desc:'华侨/华人视角国际新闻',coverage:['全球'],cycle:60,rel:'A2',feeds:['news_intel','实时风险监测']},
    {id:'DS-ME-16',name:'欧洲时报',cat:'media',icon:'📰',desc:'欧洲华人社区安全动态',coverage:['欧洲'],cycle:60,rel:'B2',feeds:['news_intel','实时风险监测']},
    /* 社交监测 · 涉华 */
    ...
    {id:'DS-SO-15',name:'小红书华侨',cat:'social',icon:'💬',desc:'华侨海外生活安全分享',coverage:['东南亚','欧美'],cycle:60,rel:'C3',feeds:['social_monitor','实时风险监测']},
    /* 商业数据 · 涉华 */
    ...
    /* 合作哨点 · 涉华 */
    {id:'DS-SE-10',name:'中资企业境外商会',cat:'sentinel',icon:'🎖️',desc:'一带一路商会安全联防',coverage:['非洲','东南亚','中东'],cycle:60,rel:'B1',feeds:['sentinel_report','威胁组织图谱']},
    {id:'DS-SE-11',name:'华人联合会',cat:'sentinel',icon:'🎖️',desc:'侨团治安信息网络(涉华)',coverage:['东南亚','欧美','非洲'],cycle:60,rel:'C1',feeds:['sentinel_report','实时风险监测']},
    {id:'DS-SE-12',name:'中资安保公司',cat:'sentinel',icon:'🎖️',desc:'驻地武装护卫/撤离服务',coverage:['非洲','中东'],cycle:60,rel:'A2',feeds:['sentinel_report','智能预警中心']},

    /* ===== 全球新闻媒体数据源注册表 v3.0（2286 条通道） ===== */
    {id:'DS-GM-01',name:'全球新闻媒体监测网',cat:'global_media',icon:'🌍',desc:'2286条通道：190国/地区×12主题(Google News国家聚合)+6家国际主流媒体，全部与中国海外利益安全(A-I九维)关联',coverage:['全球'],cycle:60,rel:'B2',feeds:['global_media','全域态势感知']}
  ];
  ...
  function renderTable(){
    ...
    box.innerHTML = '<table style="width:100%;border-collapse:collapse;font-size:11px">'+
      ...
      list.map(function(s){
        ...
        return '<tr data-dsid="'+s.id+'" class="ds-row" style="border-top:1px solid var(--border);cursor:pointer" title="点击查看数据源详情档案">'+
    ...
    /* 2026-09-05 数据源行 → 详情抽屉（此前整表无交互，是数据中枢最大死面板） */
    box.querySelectorAll('tr[data-dsid]').forEach(function(tr){
      tr.onclick = function(){ openSourceDrawer(tr.getAttribute('data-dsid')); };
    });
  }

  /* ========== 数据源详情抽屉（复合交互 2026-09-05） ========== */
  function _ensureDsStyle(){
    if(document.getElementById('ds-drawer-css')) return;
    var st = document.createElement('style'); st.id = 'ds-drawer-css';
    st.textContent =
      '.ds-drawer-mask{position:fixed;inset:0;background:rgba(4,8,14,.6);z-index:9500}'+
      '.ds-drawer{position:fixed;top:0;right:0;bottom:0;width:470px;max-width:94vw;background:var(--bg);border-left:1px solid var(--border2);z-index:9501;overflow-y:auto;box-shadow:-18px 0 50px rgba(0,0,0,.55);animation:dsDrIn .22s ease}'+
      '@keyframes dsDrIn{from{transform:translateX(40px);opacity:0}to{transform:none;opacity:1}}'+
      '.ds-dh{display:flex;align-items:flex-start;justify-content:space-between;gap:8px;padding:14px 16px;border-bottom:1px solid var(--border);position:sticky;top:0;background:var(--bg);z-index:2}'+
      '.ds-chip{background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:7px 10px;min-width:0}'+
      '.ds-chip .lb{font-size:9.5px;color:var(--text3);letter-spacing:1px;margin-bottom:3px}'+
      '.ds-chip .vl{font-size:12.5px;color:var(--text);font-weight:600;word-break:break-word}'+
      '.ds-dact{display:flex;gap:7px;flex-wrap:wrap;padding:0 16px 12px}'+
      '.ds-btn{background:var(--panel2);border:1px solid var(--border2);color:var(--text);border-radius:8px;padding:6px 12px;font-size:11.5px;cursor:pointer}'+
      '.ds-btn:hover{border-color:var(--cyan);color:var(--cyan)}'+
      '.ds-dsec{padding:12px 16px;border-top:1px solid var(--border)}'+
      '.ds-dsec h5{margin:0 0 9px;font-size:12px;color:var(--cyan);letter-spacing:.5px}'+
      '.ds-aitem{padding:7px 9px;border:1px solid var(--border);border-radius:7px;margin-bottom:6px;cursor:pointer;background:var(--bg2)}'+
      '.ds-aitem:hover{border-color:var(--cyan)}'+
      '.ds-row:hover{background:rgba(0,212,255,.05)}';
    document.head.appendChild(st);
  }
  function _escH(s){ return String(s==null?'':s).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;'); }
  function _closeDsDrawer(){ var m=document.getElementById('ds-drawer'); if(m) m.remove(); var k=document.getElementById('ds-drawer-mask'); if(k) k.remove(); }
  /* 该源入库情报匹配：source 字段与源名/feeds/desc 关键词宽松互含 */
  function _srcAlerts(s){
    if(!window.ALERTS || !ALERTS.length) return [];
    var keys=[s.name].concat(s.feeds||[]).concat(String(s.desc||'').split(/[\/／→·\s]+/)).filter(function(k){return k&&k.length>=2&&k!=='全球';});
    return ALERTS.filter(function(a){
      var src=String(a.source||''); if(!src) return false;
      return keys.some(function(k){ return src.indexOf(k)>=0 || (k.length>=3 && k.indexOf(src)>=0); });
    }).slice(0,8);
  }
  function openSourceDrawer(id){
    _ensureDsStyle();
    var s = REGISTRY.find(function(x){return x.id===id;}); if(!s) return;
    var st = state[id] || {};
    _closeDsDrawer();
    var eff = Math.round(s.cycle/(st.boost||1));
    var stColor = st.status==='online'?'var(--green)':'var(--orange)';
    var stLabel = st.status==='online'?'在线供数':'降级';
    if(s.cat==='official'){ stColor='var(--text3)'; stLabel='通道预留 · 不伪装采集'; }
    var health = st.health==null?0:st.health;
    var hColor = health>75?'var(--green)':health>50?'var(--yellow)':'var(--red)';
    var alerts = _srcAlerts(s);
    var mask=document.createElement('div'); mask.className='ds-drawer-mask'; mask.id='ds-drawer-mask';
    mask.onclick=_closeDsDrawer;
    var dr=document.createElement('div'); dr.className='ds-drawer'; dr.id='ds-drawer';
    dr.innerHTML =
      '<div class="ds-dh"><div style="min-width:0">'+
        '<div style="font-size:14.5px;font-weight:700;color:var(--text)">'+s.icon+' '+_escH(s.name)+'</div>'+
        '<div style="display:flex;gap:6px;margin-top:6px;flex-wrap:wrap;align-items:center">'+
          '<span style="font-size:10px;color:'+CATS[s.cat].color+';border:1px solid '+CATS[s.cat].color+';border-radius:9px;padding:1px 8px">'+CATS[s.cat].label+'</span>'+
          '<span style="font-size:10px;color:'+relColor(s.rel)+';border:1px solid '+relColor(s.rel)+';border-radius:9px;padding:1px 8px">可靠性 '+s.rel+'</span>'+
          '<span style="font-size:10px;color:'+stColor+'"><span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:'+stColor+';margin-right:4px"></span>'+stLabel+'</span>'+
          (st.boost>1?'<span style="font-size:10px;color:var(--orange)">⚡加速中</span>':'')+
        '</div>'+
      '</div><button class="ds-btn" id="ds-dr-close" style="flex-shrink:0">✕</button></div>'+
      '<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:12px 16px">'+
        '<div class="ds-chip"><div class="lb">采集周期</div><div class="vl">'+eff+'s'+(st.boost>1?'<span style="font-size:9.5px;color:var(--text3);font-weight:400"> / 原 '+s.cycle+'s</span>':'')+'</div></div>'+
        '<div class="ds-chip"><div class="lb">今日采集</div><div class="vl" style="color:var(--cyan)">'+(st.todayN||0)+'</div></div>'+
        '<div class="ds-chip"><div class="lb">累计入库</div><div class="vl">'+(st.totalN||0)+'</div></div>'+
        '<div class="ds-chip"><div class="lb">最后采集</div><div class="vl" style="font-size:11px">'+_escH(st.lastT||'—')+'</div></div>'+
        '<div class="ds-chip"><div class="lb">覆盖范围</div><div class="vl" style="font-size:11px">'+_escH((s.coverage||[]).join('、')||'—')+'</div></div>'+
        '<div class="ds-chip"><div class="lb">数据去向</div><div class="vl" style="font-size:11px">'+_escH((s.feeds||[]).join(' → ')||'—')+'</div></div>'+
      '</div>'+
      '<div style="padding:0 16px 12px">'+
        '<div style="display:flex;justify-content:space-between;font-size:10px;color:var(--text3);margin-bottom:4px"><span>通道健康度</span><span style="color:'+hColor+'">'+health+' / 100</span></div>'+
        '<div style="height:7px;background:var(--panel2);border-radius:4px"><div style="width:'+health+'%;height:7px;border-radius:4px;background:'+hColor+'"></div></div>'+
        '<div style="font-size:10px;color:var(--text3);margin-top:8px;line-height:1.6">'+_escH(s.desc||'')+(s.cat==='official'?'　·　官方渠道无公开API、未获授权接入，按诚实原则仅作通道预留，绝不伪造数据。':'')+'</div>'+
      '</div>'+
      '<div class="ds-dact">'+
        '<button class="ds-btn" id="ds-dr-collect">⚡ 立即采集一轮</button>'+
        '<button class="ds-btn" id="ds-dr-copy">📋 复制源档案</button>'+
        '<button class="ds-btn" id="ds-dr-goto">🔍 情报流查看</button>'+
      '</div>'+
      '<div class="ds-dsec"><h5>📥 该源最新入库情报（库内匹配 '+(alerts.length?alerts.length+' 条':'0 条')+'）</h5>'+
        (alerts.length ? alerts.map(function(a){
          var lv=a.level||a.severity||'yellow';
          var lc=lv==='red'?'var(--red)':lv==='orange'?'var(--orange)':lv==='blue'?'var(--cyan)':'var(--yellow)';
          return '<div class="ds-aitem" data-aid="'+_escH(a.id||'')+'">'+
            '<div style="display:flex;gap:6px;align-items:center;font-size:9.5px;color:var(--text3);margin-bottom:3px">'+
              '<span style="color:'+lc+';font-weight:700">●</span><span>'+_escH(a.country||'')+'</span><span style="margin-left:auto">'+_escH(String(a.time||a.date||'').slice(5,16))+'</span></div>'+
            '<div style="font-size:11.5px;color:var(--text);line-height:1.5">'+_escH(String(a.title_zh||a.title||'').slice(0,60))+'</div></div>';
        }).join('') : '<div style="font-size:11px;color:var(--text3);padding:8px 2px;line-height:1.7">库内暂未匹配到署名该源的条目。<br>可能原因：本轮尚未轮到采集 / 采集条目经融合归并后署名真实媒体 / 通道预留中。<br>可点上方「⚡ 立即采集一轮」手动触发。</div>')+
      '</div>';
    document.body.appendChild(mask); document.body.appendChild(dr);
    dr.querySelector('#ds-dr-close').onclick=_closeDsDrawer;
    dr.querySelector('#ds-dr-collect').onclick=function(){
      this.textContent='⏳ 采集中…'; var btn=this;
      try{ collectNow(); }catch(e){}
      setTimeout(function(){ btn.textContent='✅ 已触发'; setTimeout(function(){ openSourceDrawer(id); },700); },600);
    };
    dr.querySelector('#ds-dr-copy').onclick=function(){
      var txt='【数据源档案】'+s.name+'\n类别：'+CATS[s.cat].label+'　可靠性：'+s.rel+'\n状态：'+stLabel+'　健康度：'+health+'\n周期：'+eff+'s（原始 '+s.cycle+'s）　今日：'+(st.todayN||0)+' 条　累计：'+(st.totalN||0)+' 条\n覆盖：'+((s.coverage||[]).join('、'))+'\n去向：'+((s.feeds||[]).join(' → '))+'\n说明：'+(s.desc||'');
      if(navigator.clipboard){ navigator.clipboard.writeText(txt); }
      this.textContent='✅ 已复制'; var btn=this; setTimeout(function(){ btn.textContent='📋 复制源档案'; },1200);
    };
    dr.querySelector('#ds-dr-goto').onclick=function(){ _closeDsDrawer(); if(window.navigateTo) navigateTo('alerts'); };
    dr.querySelectorAll('.ds-aitem[data-aid]').forEach(function(it){
      it.onclick=function(){ var aid=it.getAttribute('data-aid'); if(aid && window.showAlertDetail){ showAlertDetail(aid); } };
    });
  }
