...
(function () {
  ...
  /* ===== 分类体系 v2.0（#627，2026-09-05）：18 事件子类（与服务端 category-standard.js 同源） ===== */
  var CATS = [
    ...
    { key: 'mass_violence', ic: '👥', label: '群体性暴力', color: '#ff7744', sub: ['骚乱暴动', '族群械斗', '打砸抢烧', '私刑'], kws: '骚乱|暴动|械斗|打砸|暴徒|私刑' },
    { key: 'crime_events', ic: '🚨', label: '社会治安事件', color: '#ff8800', sub: ['涉华案件', '抢劫盗窃', '凶杀刑案', '绑架勒索', '海事海盗'], kws: '抢劫|盗窃|凶杀|刑案|绑架勒索|海盗|治安|中资|中企|华人|华侨|中方人员' },
    { key: 'regime_change', ic: '🏛️', label: '政权变动', color: '#b366ff', sub: ['政变军变', '政府更迭', '紧急状态', '议会危机'], kws: '政变|政权更迭|临时政府|紧急状态|军方接管' },
    { key: 'election_events', ic: '🗳️', label: '选举事件', color: '#c084fc', sub: ['大选', '公投', '选举争议', '计票风波'], kws: '选举|大选|公投|投票|计票|当选' },
    { key: 'geopolitical_intel', ic: '🌐', label: '地缘外交', color: '#00d4ff', sub: ['双边关系', '多边外交', '安全预警', '战略调整', '军事部署'], kws: '外交|双边|峰会|地缘|战略|台海|南海|军演|部署' },
    { key: 'policy_shift', ic: '📜', label: '政策法规突变', color: '#8899ff', sub: ['新法案', '监管突变', '投资审查', '产业政策'], kws: '法案|法规|监管|投资审查|产业政策|新政' },
    { key: 'sanctions_data', ic: '🚫', label: '制裁与合规', color: '#ffcc00', sub: ['经济制裁', '实体清单', '出口管制', '金融制裁', '贸易限制', '反倾销'], kws: '制裁|实体清单|出口管制|OFAC|关税|禁运|反倾销|黑名单' },
    { key: 'financial_market', ic: '📉', label: '金融市场风险', color: '#ffd24d', sub: ['汇率波动', '股市债市', '银行挤兑', '债务违约'], kws: '汇率|股市|债市|违约|挤兑|货币贬值|通胀' },
    { key: 'business_climate', ic: '💼', label: '营商环境恶化', color: '#e0a800', sub: ['外资政策收紧', '国有化征收', '劳工纠纷', '税负突变', '诉讼监管'], kws: '营商环境|外资|国有化|征收|劳工|税收|经营|诉讼|仲裁|监管' },
    { key: 'social_unrest', ic: '💬', label: '社会动荡', color: '#ffaa00', sub: ['罢工停工', '抗议示威', '民众运动', '排外情绪'], kws: '罢工|示威|游行|抗议|停产|堵路|排华' },
    { key: 'public_health', ic: '🧬', label: '公共卫生', color: '#00cc88', sub: ['传染病疫情', '霍乱疟疾', '食品安全', '医疗挤兑'], kws: '疫情|传染病|霍乱|埃博拉|疟疾|食品安全|感染' },
    { key: 'cyber_security', ic: '💻', label: '网络与信息安全', color: '#77ddff', sub: ['网络攻击', '数据泄露', '勒索病毒', '间谍活动'], kws: '网络攻击|数据泄露|黑客|勒索病毒|间谍|网络安全' },
    { key: 'industrial_accident', ic: '⚠️', label: '生产安全事故', color: '#ff9966', sub: ['矿难', '火灾爆炸', '坍塌', '危化品泄漏'], kws: '矿难|火灾|爆炸|坍塌|工亡|泄漏|安全事故' },
    { key: 'environmental_event', ic: '🌿', label: '环境生态事件', color: '#88dd99', sub: ['环境污染', '原油泄漏', '化学事故', '生态破坏'], kws: '污染|原油|化学|有毒|排放|生态' },
    { key: 'natural_disasters', ic: '🌊', label: '自然灾害', color: '#00ff9f', sub: ['地震', '台风气旋', '洪水涝灾', '火山喷发', '海啸'], kws: '地震|台风|洪水|海啸|火山|山火|气旋|泥石流|干旱' },
    { key: 'infrastructure', ic: '🚧', label: '基础设施中断', color: '#66aaff', sub: ['港口码头', '铁路公路', '电站电网', '油气管道', '通信网络'], kws: '港口|铁路|公路|电站|断电|管网|园区|机场|大桥' }
  ];
  var LEVEL_META = {
  ...
  function templateOf(catKey) {
    ...
    /* v2.0 新 key 模板别名（复用同域模板再覆盖 data_type） */
    if (!Object.keys(base).length) {
      var alias = { mass_violence: 'social_unrest', crime_events: 'terror_events', regime_change: 'political_events', election_events: 'political_events', policy_shift: 'political_events', financial_market: 'economic_risk', business_climate: 'economic_risk', cyber_security: 'osint_intel', industrial_accident: 'infrastructure', environmental_event: 'natural_disasters' }[catKey];
      if (alias) { base = Object.assign({}, templateOf(alias)); }
    }
