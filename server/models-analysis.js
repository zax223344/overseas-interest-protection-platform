...
module.exports = function modelsAnalysis(ctx) {
  ...
  /* ============ 专题四：国别地缘安全风险模型 ============ */
  const GEO_DIMS = [
    /* 分类体系 v2.0（#627）：types 补新 key，旧 key 保留兼容 */
    { k: 'political', n: '政治', types: ['political_events', 'regime_change', 'election_events', 'policy_shift'], w: 0.15 },
    { k: 'economic', n: '经济', types: ['economic_risk', 'financial_market', 'business_climate'], w: 0.15 },
    { k: 'social', n: '社会', types: ['social_unrest', 'mass_violence', 'crime_events'], w: 0.15 },
