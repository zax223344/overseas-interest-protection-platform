...
const GDELT_QUERIES = [
  ...
  { id:'pak-terror',  focus:'巴基斯坦/CPEC·恐袭', region:REGIONS.pakistan,
    q:'sourcecountry:PAK (terror OR terrorist OR bombing OR suicide OR blast OR attack OR attacked OR ambush OR gunmen OR shooting OR militant OR Taliban OR ISIS OR Jaish OR Baloch OR TTP)' },
  { id:'pak-attack',  focus:'巴基斯坦/CPEC·袭击', region:REGIONS.pakistan,
    q:'sourcecountry:PAK (attack OR attacked OR assault OR raid OR ambush OR gunfire OR shooting OR bomb OR explosion OR blast OR target OR killed)' },
  { id:'pak-kidnap',  focus:'巴基斯坦/CPEC·绑架', region:REGIONS.pakistan,
    q:'sourcecountry:PAK (kidnap OR kidnapped OR kidnapping OR abduct OR abducted OR abduction OR hostage OR hostages OR ransom OR seized)' },
  { id:'pak-crime',   focus:'巴基斯坦/CPEC·重大刑案', region:REGIONS.pakistan,
    q:'sourcecountry:PAK (murder OR murdered OR killing OR killed OR dead OR massacre OR gang OR criminal OR crime OR robbery OR shootout OR violence)' },

  /* 阿富汗 */
  { id:'afg-terror',  focus:'阿富汗·恐袭', region:REGIONS.afghanistan,
    q:'sourcecountry:AFG (terror OR terrorist OR bombing OR suicide OR blast OR attack OR attacked OR ambush OR gunmen OR shooting OR militant OR Taliban OR ISIS)' },
  { id:'afg-kidnap',  focus:'阿富汗·绑架', region:REGIONS.afghanistan,
    q:'sourcecountry:AFG (kidnap OR kidnapped OR kidnapping OR abduct OR abducted OR abduction OR hostage OR hostages OR ransom)' },

  /* 非洲片区（按 sourcecountry 分批，避免布尔过长） */
  { id:'africa-mali', focus:'马里/萨赫勒·恐袭绑架', region:REGIONS.africa_sahel,
    q:'sourcecountry:MLI (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR militant OR JNIM OR Wagner OR blast OR shooting)' },
  { id:'africa-niger',focus:'尼日尔/萨赫勒·恐袭绑架', region:REGIONS.africa_sahel,
    q:'sourcecountry:NER (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR militant OR JNIM OR blast)' },
  { id:'africa-burkina',focus:'布基纳法索·恐袭绑架', region:REGIONS.africa_sahel,
    q:'sourcecountry:BFA (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR militant OR JNIM OR blast)' },
  { id:'africa-somalia',focus:'索马里·恐袭绑架', region:REGIONS.africa_horn,
    q:'sourcecountry:SOM (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR Al-Shabaab OR blast OR shooting)' },
  { id:'africa-nigeria',focus:'尼日利亚·恐袭绑架刑案', region:REGIONS.africa_west,
    q:'sourcecountry:NGA (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR bandit OR gunmen OR Boko Haram OR criminal OR murder)' },
  { id:'africa-kenya',focus:'肯尼亚·恐袭绑架刑案', region:REGIONS.africa_east,
    q:'sourcecountry:KEN (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR Al-Shabaab OR blast OR shooting)' },
  { id:'africa-car',focus:'中非·恐袭绑架', region:REGIONS.africa_central,
    q:'sourcecountry:CAF (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR militia OR blast OR shooting)' },
  { id:'africa-drc',focus:'刚果（金）·恐袭绑架刑案', region:REGIONS.africa_central,
    q:'sourcecountry:COD (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR militia OR criminal OR murder OR shooting)' },
  { id:'africa-south',focus:'南非·重大刑案', region:REGIONS.africa_south,
    q:'sourcecountry:ZAF (murder OR killed OR shooting OR gang OR robbery OR criminal OR kidnapping OR abduct)' },

  /* 中亚 */
  { id:'ca-kaz',focus:'哈萨克斯坦·安全事件', region:REGIONS.central_asia,
    q:'sourcecountry:KAZ (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR criminal OR murder)' },
  { id:'ca-kgz',focus:'吉尔吉斯斯坦·安全事件', region:REGIONS.central_asia,
    q:'sourcecountry:KGZ (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR criminal)' },
  { id:'ca-tjk',focus:'塔吉克斯坦·安全事件', region:REGIONS.central_asia,
    q:'sourcecountry:TJK (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR criminal)' },
  { id:'ca-uzb',focus:'乌兹别克斯坦·安全事件', region:REGIONS.central_asia,
    q:'sourcecountry:UZB (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR criminal)' },

  /* 东南亚 */
  { id:'sea-myanmar',focus:'缅甸·恐袭刑案', region:REGIONS.southeast_asia,
    q:'sourcecountry:MMR (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR coup OR junta OR military OR insurgent)' },
  { id:'sea-philippines',focus:'菲律宾·恐袭绑架', region:REGIONS.southeast_asia,
    q:'sourcecountry:PHL (terror OR attack OR kidnap OR kidnapped OR abduct OR hostage OR Abu Sayyaf OR blast OR shooting)' },
  { id:'sea-thailand',focus:'泰国·恐袭绑架刑案', region:REGIONS.southeast_asia,
    q:'sourcecountry:THA (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR criminal)' },
  { id:'sea-indonesia',focus:'印尼·恐袭刑案', region:REGIONS.southeast_asia,
    q:'sourcecountry:IDN (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR militant)' },
  { id:'sea-malaysia',focus:'马来西亚·恐袭绑架刑案', region:REGIONS.southeast_asia,
    q:'sourcecountry:MYS (terror OR attack OR kidnap OR abduct OR hostage OR blast OR shooting OR criminal)' }
];
