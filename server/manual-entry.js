...
/* 情报类别受控词表（#627 分类体系 v2.0：18 事件子类 + 旧 key 兼容；
 * 写入 intel_data 由 DB 触发器归一，此处仅做录入校验） */
const CATS = (function () {
  const m = {
    terror_events: '恐怖袭击',
    ...
    crime_events: '社会治安事件',
    regime_change: '政权变动',
    election_events: '选举事件',
    geopolitical_intel: '地缘外交',
    policy_shift: '政策法规突变',
    sanctions_data: '制裁与合规',
    financial_market: '金融市场风险',
    business_climate: '营商环境恶化',
    social_unrest: '社会动荡',
    public_health: '公共卫生',
    cyber_security: '网络与信息安全',
    industrial_accident: '生产安全事故',
    environmental_event: '环境生态事件',
    natural_disasters: '自然灾害',
    infrastructure: '基础设施中断',
    /* 退役旧 key（兼容旧客户端提交） */
