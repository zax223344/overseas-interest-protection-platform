...
const DIRECT_RSS = [
  ...
  _m('国际', 'INT', REGIONS.NORTH_AMERICA, 'Voice of America', 'https://www.voanews.com/api/zt$gteitim', 'en', '美国对外广播'),
  _m('国际', 'INT', REGIONS.NORTH_AMERICA, 'Radio Free Europe', 'https://www.rferl.org/api/zv$gteitim', 'en', '欧亚、人权'),
  _m('国际', 'INT', REGIONS.NORTH_AMERICA, 'Nikkei Asia', 'https://asia.nikkei.com/rss/news/feed/', 'en', '亚太财经'),
  _m('国际', 'INT', REGIONS.HONG_KONG, 'South China Morning Post', 'https://www.scmp.com/rss/91/feed', 'en', '中国、亚太'),
  ...
  _m('美国', 'USA', REGIONS.NORTH_AMERICA, 'Axios World', 'https://api.axios.com/feed/world/', 'en', '全球简报'),
  ...
  _m('瑞典', 'SWE', REGIONS.EUROPE, 'The Local Sweden', 'https://www.thelocal.se/feeds/general.xml', 'en', '瑞典'),
  _m('挪威', 'NOR', REGIONS.EUROPE, 'The Local Norway', 'https://www.thelocal.no/feeds/general.xml', 'en', '挪威'),
  _m('丹麦', 'DNK', REGIONS.EUROPE, 'The Local Denmark', 'https://www.thelocal.dk/feeds/general.xml', 'en', '丹麦'),
  ...
  _m('波兰', 'POL', REGIONS.EUROPE, 'Poland In', 'https://polandin.com/RSS', 'en', '波兰'),
  _m('捷克', 'CZE', REGIONS.EUROPE, 'Prague Morning', 'https://praguemorning.cz/feed/', 'en', '捷克'),
  _m('捷克', 'CZE', REGIONS.EUROPE, 'Radio Prague International', 'https://english.radio.cz/rss', 'en', '捷克'),
  _m('匈牙利', 'HUN', REGIONS.EUROPE, 'Hungary Today', 'https://hungarytoday.hu/feed/', 'en', '匈牙利'),
  _m('奥地利', 'AUT', REGIONS.EUROPE, 'The Local Austria', 'https://www.thelocal.at/feeds/general.xml', 'en', '奥地利'),
  _m('爱尔兰', 'IRL', REGIONS.EUROPE, 'Irish Times World', 'https://www.irishtimes.com/rss/world~rss2/index.xml', 'en', '国际'),
  ...
  _m('保加利亚', 'BGR', REGIONS.EUROPE, 'Sofia Globe', 'https://sofiaglobe.com/feed/', 'en', '保加利亚'),
  _m('克罗地亚', 'HRV', REGIONS.EUROPE, 'Total Croatia News', 'https://www.total-croatia-news.com/rss.xml', 'en', '克罗地亚'),
  ...
  /* ---------------- 东亚 ---------------- */
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'China Daily World', 'https://www.chinadaily.com.cn/rss/world_news.xml', 'en', '中国国际'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'Global Times', 'https://www.globaltimes.cn/rss/outbrain.xml', 'en', '中国国际评论'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'CGTN World', 'https://news.cgtn.com/rss/world.xml', 'en', '中国环球电视'),
  ...
  _m('日本', 'JPN', REGIONS.EAST_ASIA, 'Nikkei Asia', 'https://asia.nikkei.com/rss/news/feed/', 'en', '亚太财经'),
  ...
  _m('印度尼西亚', 'IDN', REGIONS.SOUTHEAST_ASIA, 'Jakarta Post', 'https://www.thejakartapost.com/feed', 'en', '印尼'),
  ...
  _m('越南', 'VNM', REGIONS.SOUTHEAST_ASIA, 'VietnamNet', 'https://english.vietnamnet.vn/rss/index.html', 'en', '越南'),
  ...
  _m('阿联酋', 'ARE', REGIONS.MIDDLE_EAST, 'Zawya', 'https://www.zawya.com/en/rss', 'en', '中东经济/合规'),
  ...
  _m('肯尼亚', 'KEN', REGIONS.EAST_AFRICA, 'The Star Kenya', 'https://www.the-star.co.ke/feed/', 'en', '肯尼亚/东非安全'),
  ...
  _m('美国', 'USA', REGIONS.NORTH_AMERICA, 'CTC Sentinel', 'https://ctc.westpoint.edu/feed/', 'en', '西点反恐中心'),
  ...
  _m('利比亚', 'LBY', REGIONS.NORTH_AFRICA, 'Libya Observer', 'https://libyaobserver.ly/rss', 'en', '利比亚冲突'),
  ...
  _m('喀麦隆', 'CMR', REGIONS.WEST_AFRICA, 'Journal du Cameroun', 'https://www.journalducameroun.com/en/feed/', 'en', '喀麦隆/极北区'),
  _m('中非', 'CAF', REGIONS.WEST_AFRICA, 'Corbeau News', 'https://corbeaunews-centrafrique.com/feed/', 'fr', '中非共和国冲突'),
  ...
  _m('孟加拉国', 'BGD', REGIONS.SOUTH_ASIA, 'Dhaka Tribune', 'https://www.dhakatribune.com/feed', 'en', '孟加拉国'),
  _m('斯里兰卡', 'LKA', REGIONS.SOUTH_ASIA, 'Daily Mirror', 'https://www.dailymirror.lk/rss', 'en', '斯里兰卡'),
  _m('斯里兰卡', 'LKA', REGIONS.SOUTH_ASIA, 'The Sunday Times Sri Lanka', 'https://www.sundaytimes.lk/feed/', 'en', '斯里兰卡'),
  ...
  _m('马尔代夫', 'MDV', REGIONS.SOUTH_ASIA, 'Maldives Independent', 'https://maldivesindependent.com/feed/', 'en', '马尔代夫'),
  _m('不丹', 'BTN', REGIONS.SOUTH_ASIA, 'Kuensel', 'https://kuenselonline.com/feed/', 'en', '不丹'),

  /* ---------------- 中亚 ---------------- */
  _m('哈萨克斯坦', 'KAZ', REGIONS.CENTRAL_ASIA, 'Astana Times', 'https://astanatimes.com/feed/', 'en', '哈萨克斯坦'),
  _m('哈萨克斯坦', 'KAZ', REGIONS.CENTRAL_ASIA, 'Kazinform', 'https://www.inform.kz/en/rss', 'en', '哈萨克斯坦'),
  ...
  _m('约旦', 'JOR', REGIONS.MIDDLE_EAST, 'Jordan Times', 'http://jordantimes.com/rss', 'en', '约旦'),
  _m('以色列', 'ISR', REGIONS.MIDDLE_EAST, 'Jerusalem Post', 'https://www.jpost.com/Rss/RssFeedsHeadlines.aspx', 'en', '以色列'),
  _m('以色列', 'ISR', REGIONS.MIDDLE_EAST, 'Haaretz', 'https://www.haaretz.com/misc/rss', 'en', '以色列'),
  _m('沙特阿拉伯', 'SAU', REGIONS.MIDDLE_EAST, 'Arab News', 'https://www.arabnews.com/rss', 'en', '沙特/中东'),
  _m('沙特阿拉伯', 'SAU', REGIONS.MIDDLE_EAST, 'Saudi Gazette', 'https://saudigazette.com.sa/feed/', 'en', '沙特'),
  _m('阿联酋', 'ARE', REGIONS.MIDDLE_EAST, 'Gulf News', 'https://gulfnews.com/rss', 'en', '阿联酋/海湾'),
  _m('阿联酋', 'ARE', REGIONS.MIDDLE_EAST, 'The National', 'https://www.thenationalnews.com/rss', 'en', '阿联酋'),
  ...
  _m('科威特', 'KWT', REGIONS.MIDDLE_EAST, 'Kuwait Times', 'https://www.kuwaittimes.com/feed/', 'en', '科威特'),
  _m('阿曼', 'OMN', REGIONS.MIDDLE_EAST, 'Times of Oman', 'https://timesofoman.com/feed', 'en', '阿曼'),
  _m('巴林', 'BHR', REGIONS.MIDDLE_EAST, 'Gulf Daily News', 'https://www.gdnonline.com/rss', 'en', '巴林'),
  ...
  _m('埃及', 'EGY', REGIONS.NORTH_AFRICA, 'Ahram Online', 'http://english.ahram.org.eg/rss', 'en', '埃及'),
  _m('利比亚', 'LBY', REGIONS.NORTH_AFRICA, 'Libya Herald', 'https://libyaherald.com/feed/', 'en', '利比亚'),
  _m('利比亚', 'LBY', REGIONS.NORTH_AFRICA, 'Libya Observer', 'https://libyaobserver.ly/feed', 'en', '利比亚'),
  _m('阿尔及利亚', 'DZA', REGIONS.NORTH_AFRICA, 'Algeria Press Service', 'https://www.aps.dz/en/feed', 'en', '阿尔及利亚'),
  ...
  _m('加纳', 'GHA', REGIONS.WEST_AFRICA, 'Graphic Online', 'https://www.graphic.com.gh/feed', 'en', '加纳'),
  ...
  _m('尼日尔', 'NER', REGIONS.WEST_AFRICA, 'Nigerdiaspora', 'https://nigerdiaspora.net/feed/', 'fr', '尼日尔'),
  _m('毛里塔尼亚', 'MRT', REGIONS.WEST_AFRICA, 'Mauriweb', 'https://mauriweb.info/feed', 'fr', '毛里塔尼亚'),
  ...
  _m('多哥', 'TGO', REGIONS.WEST_AFRICA, 'Togo First', 'https://togofirst.com/feed', 'fr', '多哥'),
  ...
  _m('索马里', 'SOM', REGIONS.EAST_AFRICA, 'Hiiraan Online', 'https://www.hiiraan.com/rss', 'en', '索马里'),
  _m('厄立特里亚', 'ERI', REGIONS.EAST_AFRICA, 'Eritrea Hub', 'https://eritreahub.org/feed/', 'en', '厄立特里亚'),
  _m('吉布提', 'DJI', REGIONS.EAST_AFRICA, 'Djibouti News', 'https://djiboutinews.com/feed/', 'en', '吉布提'),

  /* ---------------- 南部非洲 ---------------- */
  _m('南非', 'ZAF', REGIONS.SOUTHERN_AFRICA, 'News24', 'https://feeds.capi24.com/v1/Search/articles/news24/TopStories/rss', 'en', '南非'),
  _m('南非', 'ZAF', REGIONS.SOUTHERN_AFRICA, 'Mail & Guardian', 'https://mg.co.za/feed/', 'en', '南非'),
  ...
  _m('博茨瓦纳', 'BWA', REGIONS.SOUTHERN_AFRICA, 'Mmegi Online', 'https://www.mmegi.bw/feed', 'en', '博茨瓦纳'),
  ...
  _m('马达加斯加', 'MDG', REGIONS.SOUTHERN_AFRICA, 'Madagascar Independent', 'https://madagascar-independent.com/feed/', 'en', '马达加斯加'),
  ...
  _m('智利', 'CHL', REGIONS.LATIN_AMERICA, 'La Tercera', 'https://www.latercera.com/feed/', 'es', '智利'),
  ...
  _m('巴拉圭', 'PRY', REGIONS.LATIN_AMERICA, 'ABC Color', 'https://www.abc.com.py/feed/', 'es', '巴拉圭'),
  ...
  _m('洪都拉斯', 'HND', REGIONS.LATIN_AMERICA, 'La Prensa Honduras', 'https://www.laprensa.hn/feed/', 'es', '洪都拉斯'),
  ...
  _m('海地', 'HTI', REGIONS.LATIN_AMERICA, 'Haiti Libre', 'https://www.haitilibre.com/feed/', 'fr', '海地'),
  _m('牙买加', 'JAM', REGIONS.LATIN_AMERICA, 'Jamaica Observer', 'https://www.jamaicaobserver.com/feed/', 'en', '牙买加'),
  ...
  /* ---------------- 北亚/俄罗斯 ---------------- */
  _m('俄罗斯', 'RUS', REGIONS.RUSSIA_CIS, 'The Moscow Times', 'https://www.themoscowtimes.com/rss/news', 'en', '俄罗斯'),
  _m('俄罗斯', 'RUS', REGIONS.RUSSIA_CIS, 'Meduza', 'https://meduza.io/en/rss/all', 'en', '俄罗斯独立'),
  _m('俄罗斯', 'RUS', REGIONS.RUSSIA_CIS, 'TASS', 'https://tass.com/rss/v2.xml', 'en', '俄罗斯官方'),
  ...
  _m('白俄罗斯', 'BLR', REGIONS.RUSSIA_CIS, 'Belsat', 'https://belsat.eu/feed/', 'en', '白俄罗斯'),
...
const THINK_TANK_FEEDS = [
  /* ---------------- 美国 ---------------- */
  _t('美国', 'USA', REGIONS.NORTH_AMERICA, 'CSIS Analysis', 'https://www.csis.org/rss', 'en', '战略与国际研究'),
  ...
  _t('美国', 'USA', REGIONS.NORTH_AMERICA, 'CFR Analysis', 'https://www.cfr.org/rss.xml', 'en', '外交关系'),
  ...
  _t('美国', 'USA', REGIONS.NORTH_AMERICA, 'Wilson Center', 'https://www.wilsoncenter.org/rss', 'en', '国际事务'),
  ...
  _t('美国', 'USA', REGIONS.NORTH_AMERICA, 'CNAS', 'https://www.cnas.org/rss', 'en', '新美国安全'),
  ...
  _t('美国', 'USA', REGIONS.NORTH_AMERICA, 'Hudson Institute', 'https://www.hudson.org/feed', 'en', '保守派智库'),
  ...
  _t('美国', 'USA', REGIONS.NORTH_AMERICA, 'Council on Foreign Relations Asia', 'https://www.cfr.org/asia/rss.xml', 'en', '亚洲'),
  ...
  _t('英国', 'GBR', REGIONS.EUROPE, 'RUSI', 'https://rusi.org/feed', 'en', '防务安全'),
  ...
  _t('英国', 'GBR', REGIONS.EUROPE, 'Royal United Services Institute', 'https://rusi.org/feed', 'en', '防务'),

  /* ---------------- 法国 ---------------- */
  _t('法国', 'FRA', REGIONS.EUROPE, 'IFRI', 'https://www.ifri.org/en/rss', 'en', '国际关系'),
  ...
  _t('法国', 'FRA', REGIONS.EUROPE, 'Asia Centre', 'https://asiacentre.fr/feed/', 'en', '亚洲研究'),

  /* ---------------- 德国 ---------------- */
  _t('德国', 'DEU', REGIONS.EUROPE, 'SWP Berlin', 'https://www.swp-berlin.org/feed/', 'en', '国际政治'),
  _t('德国', 'DEU', REGIONS.EUROPE, 'DGAP', 'https://dgap.org/en/rss', 'en', '对外关系'),
  _t('德国', 'DEU', REGIONS.EUROPE, 'MERICS', 'https://merics.org/en/rss', 'en', '中国研究'),
  _t('德国', 'DEU', REGIONS.EUROPE, 'Kiel Institute', 'https://www.ifw-kiel.de/feed/', 'en', '世界经济'),
  _t('德国', 'DEU', REGIONS.EUROPE, 'Bertelsmann Stiftung', 'https://www.bertelsmann-stiftung.de/en/rss', 'en', '欧洲'),

  /* ---------------- 欧盟/欧洲其他 ---------------- */
  _t('欧盟', 'EUE', REGIONS.EUROPE, 'ECFR', 'https://ecfr.eu/feed/', 'en', '欧洲对外关系'),
  _t('欧盟', 'EUE', REGIONS.EUROPE, 'Bruegel', 'https://www.bruegel.org/rss', 'en', '经济'),
  ...
  _t('波兰', 'POL', REGIONS.EUROPE, 'PISM', 'https://www.pism.pl/feed', 'en', '波兰国际'),
  _t('捷克', 'CZE', REGIONS.EUROPE, 'Association for International Affairs', 'https://www.amo.cz/en/rss', 'en', '国际事务'),
  ...
  _t('俄罗斯', 'RUS', REGIONS.RUSSIA_CIS, 'Valdai Club', 'https://valdaiclub.com/feed/', 'en', '俄罗斯视角'),
  _t('俄罗斯', 'RUS', REGIONS.RUSSIA_CIS, 'RIAC', 'https://russiancouncil.ru/en/feed/', 'en', '国际事务'),

  /* ---------------- 中国 ---------------- */
  _t('中国', 'CHN', REGIONS.EAST_ASIA, 'CIIS', 'http://www.ciis.org.cn/english/rss', 'en', '中国国际问题研究院'),
  _t('中国', 'CHN', REGIONS.EAST_ASIA, 'CICIR', 'http://www.cicir.ac.cn/rss', 'en', '现代国际关系研究院'),
  _t('中国', 'CHN', REGIONS.EAST_ASIA, 'Pangoal', 'http://www.pangoal.cn/rss', 'zh', '盘古智库'),
  _t('中国', 'CHN', REGIONS.EAST_ASIA, 'Shanghai Institutes', 'https://www.siis.org.cn/rss', 'zh', '上海国际问题研究院'),
  _t('中国', 'CHN', REGIONS.EAST_ASIA, 'CF40', 'https://www.cf40.com.cn/rss', 'zh', '金融四十人论坛'),
  _t('中国', 'CHN', REGIONS.EAST_ASIA, 'CASS', 'http://cass.cssn.cn/rss', 'zh', '中国社会科学院'),

  /* ---------------- 日本 ---------------- */
  _t('日本', 'JPN', REGIONS.EAST_ASIA, 'JIIA', 'https://www2.jiia.or.jp/en/rss', 'en', '国际问题研究所'),
  _t('日本', 'JPN', REGIONS.EAST_ASIA, 'NIDS', 'https://www.nids.mod.go.jp/english/rss', 'en', '防卫研究所'),
  _t('日本', 'JPN', REGIONS.EAST_ASIA, 'Tokyo Foundation', 'https://www.tkfd.or.jp/feed', 'en', '政策研究'),

  /* ---------------- 韩国 ---------------- */
  _t('韩国', 'KOR', REGIONS.EAST_ASIA, 'KIDA', 'https://www.kida.re.kr/english/rss', 'en', '国防分析'),
  _t('韩国', 'KOR', REGIONS.EAST_ASIA, 'Asan Institute', 'https://www.asaninst.org/feed/', 'en', '亚洲政策'),
  _t('韩国', 'KOR', REGIONS.EAST_ASIA, 'Seoul Institute', 'https://si.re.kr/feed', 'en', '首尔研究院'),

  /* ---------------- 印度 ---------------- */
  _t('印度', 'IND', REGIONS.SOUTH_ASIA, 'ORF', 'https://www.orfonline.org/feed/', 'en', '观察家研究基金会'),
  ...
  _t('伊朗', 'IRN', REGIONS.MIDDLE_EAST, 'IRIS', 'https://www.iris.org.ir/feed/', 'en', '国际研究'),

  /* ---------------- 拉美 ---------------- */
  _t('巴西', 'BRA', REGIONS.LATIN_AMERICA, 'Fundação Getulio Vargas', 'https://portal.fgv.br/en/rss', 'pt', '巴西智库'),
  _t('阿根廷', 'ARG', REGIONS.LATIN_AMERICA, 'CARI', 'https://cari.org.ar/feed/', 'es', '国际关系'),
  _t('智利', 'CHL', REGIONS.LATIN_AMERICA, 'CIEPLAN', 'https://www.cieplan.org/feed/', 'es', '经济'),
  _t('墨西哥', 'MEX', REGIONS.LATIN_AMERICA, 'COMEXI', 'https://www.comexi.org/feed/', 'es', '国际关系')
];
...
const CHINA_FOCUS_SOURCES = [
  /* 中文/中国官方与主流英文媒体 */
  _m('中国', 'CHN', REGIONS.EAST_ASIA, '新华社英文', 'http://www.xinhuanet.com/english/world/rss.xml', 'en', '中国官方新闻'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, '中国日报', 'https://www.chinadaily.com.cn/rss/world_rss.xml', 'en', '中国对外新闻'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, '环球时报英文', 'https://www.globaltimes.cn/rss/index.xml', 'en', '中国视角国际'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'CGTN Opinions', 'https://www.cgtn.com/subscribe/rss/opinions.xml', 'en', '中国环球电视网'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'CGTN World', 'https://www.cgtn.com/subscribe/rss/world.xml', 'en', '中国环球电视网国际'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, '中国新闻社', 'https://www.ecns.cn/rss/rss.xml', 'en', '中国新闻'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, '人民日报英文', 'http://en.people.cn/rss/92024.xml', 'en', '人民日报国际'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, '上海日报', 'https://www.shine.cn/rss/news.xml', 'en', '上海英文新闻'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'Caixin Global', 'https://www.caixinglobal.com/news/rss.xml', 'en', '财新中国'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'Sixth Tone', 'https://www.sixthtone.com/rss', 'en', '中国叙事'),
  _m('中国', 'CHN', REGIONS.EAST_ASIA, 'China Daily Business', 'https://www.chinadaily.com.cn/rss/business_rss.xml', 'en', '中国财经'),

  /* 中国香港/中国台湾 */
  _m('中国香港', 'HKG', REGIONS.EAST_ASIA, 'South China Morning Post', 'https://www.scmp.com/rss/91/feed', 'en', '香港视角中国'),
  _m('中国香港', 'HKG', REGIONS.EAST_ASIA, 'SCMP China', 'https://www.scmp.com/rss/95/feed', 'en', '香港视角中国'),
  _m('中国香港', 'HKG', REGIONS.EAST_ASIA, 'SCMP Asia', 'https://www.scmp.com/rss/5/feed', 'en', '香港视角亚太'),
  ...
  _m('中国台湾', 'TWN', REGIONS.EAST_ASIA, 'Focus Taiwan', 'https://focustaiwan.tw/rss', 'en', '台湾中央社英文'),

  /* 国际主流媒体涉华/亚太频道 */
  _m('国际', 'INT', REGIONS.NORTH_AMERICA, 'Nikkei Asia', 'https://asia.nikkei.com/rss/news/feed/', 'en', '亚太财经涉华'),
  ...
  _m('国际', 'INT', REGIONS.NORTH_AMERICA, 'CSIS', 'https://www.csis.org/rss', 'en', '美国战略与国际研究中心'),
  ...
  _m('国际', 'INT', REGIONS.NORTH_AMERICA, 'Bloomberg Markets', 'https://www.bloomberg.com/feeds/markets.rss', 'en', '全球财经'),
...
const CHINA_NEGATIVE_SOURCES = [
  ...
  _m('国际', 'INT', REGIONS.HONG_KONG, 'SCMP China', 'https://www.scmp.com/rss/95/feed', 'en', '香港视角中国'),
  ...
  _m('巴基斯坦', 'PAK', REGIONS.SOUTH_ASIA, 'Pakistan Today', 'https://www.pakistantoday.com.pk/feed/', 'en', '巴基斯坦'),
  ...
  _m('印度', 'IND', REGIONS.SOUTH_ASIA, 'Scroll.in', 'https://scroll.in/rss', 'en', '印度'),
  _m('印度', 'IND', REGIONS.SOUTH_ASIA, 'The Quint', 'https://www.thequint.com/rss', 'en', '印度'),
  ...
  _m('孟加拉国', 'BGD', REGIONS.SOUTH_ASIA, 'Dhaka Tribune', 'https://www.dhakatribune.com/feed', 'en', '孟加拉国'),
  _m('孟加拉国', 'BGD', REGIONS.SOUTH_ASIA, 'Prothom Alo English', 'https://en.prothomalo.com/rss', 'en', '孟加拉国'),
  _m('马尔代夫', 'MDV', REGIONS.SOUTH_ASIA, 'The Edition Maldives', 'https://edition.mv/rss', 'en', '马尔代夫'),
  _m('不丹', 'BTN', REGIONS.SOUTH_ASIA, 'Kuensel', 'https://kuenselonline.com/feed/', 'en', '不丹'),
  ...
  _m('土库曼斯坦', 'TKM', REGIONS.CENTRAL_ASIA, 'Turkmenistan.gov.tm', 'https://turkmenistan.gov.tm/en/rss', 'en', '土库曼斯坦'),
  _m('乌兹别克斯坦', 'UZB', REGIONS.CENTRAL_ASIA, 'UzDaily', 'https://uzdaily.com/rss', 'en', '乌兹别克斯坦'),
  _m('乌兹别克斯坦', 'UZB', REGIONS.CENTRAL_ASIA, 'Kun.uz', 'https://kun.uz/en/rss', 'en', '乌兹别克斯坦'),
  _m('乌兹别克斯坦', 'UZB', REGIONS.CENTRAL_ASIA, 'Gazeta.uz', 'https://www.gazeta.uz/en/rss/', 'en', '乌兹别克斯坦'),
  _m('阿富汗', 'AFG', REGIONS.SOUTH_ASIA, 'Khaama Press', 'https://www.khaama.com/feed/', 'en', '阿富汗'),
  _m('阿富汗', 'AFG', REGIONS.SOUTH_ASIA, 'Tolo News', 'https://tolonews.com/rss', 'en', '阿富汗'),
  _m('阿富汗', 'AFG', REGIONS.SOUTH_ASIA, 'Pajhwok Afghan News', 'https://www.pajhwok.com/en/rss', 'en', '阿富汗'),
  _m('阿富汗', 'AFG', REGIONS.SOUTH_ASIA, 'Afghanistan Times', 'https://www.afghanistantimes.af/feed/', 'en', '阿富汗'),
  ...
  _m('南非', 'ZAF', REGIONS.SOUTHERN_AFRICA, 'Mail & Guardian', 'https://mg.co.za/feed/', 'en', '南非'),
  _m('南非', 'ZAF', REGIONS.SOUTHERN_AFRICA, 'News24', 'https://feeds.capi24.com/v1/Search/articles/news24/TopStories/rss', 'en', '南非'),
  _m('南非', 'ZAF', REGIONS.SOUTHERN_AFRICA, 'Times Live', 'https://www.timeslive.co.za/rss/', 'en', '南非'),
  _m('南非', 'ZAF', REGIONS.SOUTHERN_AFRICA, 'Business Day', 'https://www.businesslive.co.za/rss/', 'en', '南非财经'),
  ...
  _m('肯尼亚', 'KEN', REGIONS.EAST_AFRICA, 'Daily Nation', 'https://nation.africa/kenya/rss.xml', 'en', '肯尼亚'),
  _m('肯尼亚', 'KEN', REGIONS.EAST_AFRICA, 'The Star Kenya', 'https://www.the-star.co.ke/rss', 'en', '肯尼亚'),
  _m('肯尼亚', 'KEN', REGIONS.EAST_AFRICA, 'Capital FM Kenya', 'https://www.capitalfm.co.ke/news/feed/', 'en', '肯尼亚'),
  _m('埃塞俄比亚', 'ETH', REGIONS.EAST_AFRICA, 'Addis Standard', 'https://addisstandard.com/feed/', 'en', '埃塞俄比亚'),
  _m('埃塞俄比亚', 'ETH', REGIONS.EAST_AFRICA, 'Ethiopian Herald', 'https://www.ethiopianherald.com/feed', 'en', '埃塞俄比亚'),
  ...
  _m('阿尔及利亚', 'DZA', REGIONS.NORTH_AFRICA, 'Algeria Press Service', 'https://www.aps.dz/en/rss', 'en', '阿尔及利亚'),
  _m('突尼斯', 'TUN', REGIONS.NORTH_AFRICA, 'Tunis Afrique Presse', 'https://www.tap.info.tn/en/rss', 'en', '突尼斯'),
  _m('利比亚', 'LBY', REGIONS.NORTH_AFRICA, 'Libya Herald', 'https://www.libyaherald.com/feed/', 'en', '利比亚'),
  _m('利比亚', 'LBY', REGIONS.NORTH_AFRICA, 'Libya Observer', 'https://libyaobserver.ly/rss', 'en', '利比亚'),
  _m('苏丹', 'SDN', REGIONS.NORTH_AFRICA, 'Sudan Tribune', 'https://sudantribune.com/feed/', 'en', '苏丹'),
  _m('加纳', 'GHA', REGIONS.WEST_AFRICA, 'GhanaWeb', 'https://www.ghanaweb.com/GhanaHomePage/rss.php', 'en', '加纳'),
  _m('加纳', 'GHA', REGIONS.WEST_AFRICA, 'Graphic Online', 'https://www.graphic.com.gh/?format=feed', 'en', '加纳'),
  _m('塞内加尔', 'SEN', REGIONS.WEST_AFRICA, 'Seneweb', 'https://www.seneweb.com/news/rss.php', 'fr', '塞内加尔'),
  _m('科特迪瓦', 'CIV', REGIONS.WEST_AFRICA, 'Abidjan.net', 'https://news.abidjan.net/rss/', 'fr', '科特迪瓦'),
  _m('马里', 'MLI', REGIONS.WEST_AFRICA, 'Maliweb', 'https://www.maliweb.net/feed', 'fr', '马里'),
  _m('尼日尔', 'NER', REGIONS.WEST_AFRICA, 'Niger Inter', 'https://www.nigerinter.info/feed/', 'fr', '尼日尔'),
  _m('布基纳法索', 'BFA', REGIONS.WEST_AFRICA, 'Burkina24', 'https://burkina24.com/feed/', 'fr', '布基纳法索'),
  _m('坦桑尼亚', 'TZA', REGIONS.EAST_AFRICA, 'The Citizen Tanzania', 'https://www.thecitizen.co.tz/rss', 'en', '坦桑尼亚'),
  _m('坦桑尼亚', 'TZA', REGIONS.EAST_AFRICA, 'Daily News Tanzania', 'https://dailynews.co.tz/feed/', 'en', '坦桑尼亚'),
  _m('乌干达', 'UGA', REGIONS.EAST_AFRICA, 'Daily Monitor Uganda', 'https://www.monitor.co.ug/rss', 'en', '乌干达'),
  _m('乌干达', 'UGA', REGIONS.EAST_AFRICA, 'New Vision Uganda', 'https://www.newvision.co.ug/feed/', 'en', '乌干达'),
  _m('卢旺达', 'RWA', REGIONS.EAST_AFRICA, 'The New Times Rwanda', 'https://www.newtimes.co.rw/rss', 'en', '卢旺达'),
  _m('索马里', 'SOM', REGIONS.EAST_AFRICA, 'Hiiraan Online', 'https://hiiraan.com/rss', 'en', '索马里'),
  ...
  _m('喀麦隆', 'CMR', REGIONS.CENTRAL_AFRICA, 'Journal du Cameroun', 'https://www.journalducameroun.com/en/rss/', 'en', '喀麦隆'),
  _m('乍得', 'TCD', REGIONS.CENTRAL_AFRICA, 'Tchad Infos', 'https://tchadinfos.com/feed/', 'fr', '乍得'),

  /* ===== 新增：中东各国媒体（大量补充）===== */
  _m('伊朗', 'IRN', REGIONS.MIDDLE_EAST, 'Tehran Times', 'https://www.tehrantimes.com/rss', 'en', '伊朗'),
  _m('伊朗', 'IRN', REGIONS.MIDDLE_EAST, 'Press TV', 'https://www.presstv.ir/rss', 'en', '伊朗'),
  _m('伊朗', 'IRN', REGIONS.MIDDLE_EAST, 'Mehr News', 'https://en.mehrnews.com/rss', 'en', '伊朗'),
  _m('伊朗', 'IRN', REGIONS.MIDDLE_EAST, 'Tasnim News', 'https://www.tasnimnews.com/en/rss', 'en', '伊朗'),
  ...
  _m('黎巴嫩', 'LBN', REGIONS.MIDDLE_EAST, 'Al-Akhbar English', 'https://english.al-akhbar.com/rss', 'en', '黎巴嫩'),
  ...
  _m('阿联酋', 'ARE', REGIONS.MIDDLE_EAST, 'Gulf News', 'https://gulfnews.com/rss', 'en', '阿联酋'),
  _m('阿联酋', 'ARE', REGIONS.MIDDLE_EAST, 'Khaleej Times', 'https://www.khaleejtimes.com/rss', 'en', '阿联酋'),
  ...
  _m('科威特', 'KWT', REGIONS.MIDDLE_EAST, 'Kuwait Times', 'https://kuwaittimes.com/feed/', 'en', '科威特'),
  _m('巴林', 'BHR', REGIONS.MIDDLE_EAST, 'Gulf Daily News', 'https://www.gdnonline.com/rss', 'en', '巴林'),
  _m('阿曼', 'OMN', REGIONS.MIDDLE_EAST, 'Times of Oman', 'https://timesofoman.com/rss', 'en', '阿曼'),
  ...
  _m('叙利亚', 'SYR', REGIONS.MIDDLE_EAST, 'Syria Times', 'https://www.syriatimes.sy/rss', 'en', '叙利亚'),
  ...
  /* ===== 新增：东南亚/大洋洲区域媒体 ===== */
  _m('越南', 'VNM', REGIONS.SOUTHEAST_ASIA, 'VietnamNet', 'https://vietnamnet.vn/rss/english', 'en', '越南'),
  _m('柬埔寨', 'KHM', REGIONS.SOUTHEAST_ASIA, 'Khmer Times', 'https://www.khmertimeskh.com/feed/', 'en', '柬埔寨'),
  _m('老挝', 'LAO', REGIONS.SOUTHEAST_ASIA, 'Vientiane Times', 'https://www.vientianetimes.org.la/rss', 'en', '老挝'),
  _m('孟加拉国', 'BGD', REGIONS.SOUTH_ASIA, 'The Daily Star Bangladesh', 'https://www.thedailystar.net/rss/news', 'en', '孟加拉国'),
  _m('斯里兰卡', 'LKA', REGIONS.SOUTH_ASIA, 'Colombo Gazette', 'https://colombogazette.com/feed/', 'en', '斯里兰卡'),
  ...
  _m('新西兰', 'NZL', REGIONS.OCEANIA, 'RNZ News', 'https://www.rnz.co.nz/rss/national.xml', 'en', '新西兰'),

  /* ===== 新增：欧洲区域媒体（补充） ===== */
  _m('土耳其', 'TUR', REGIONS.EUROPE, 'Daily Sabah', 'https://www.dailysabah.com/rss', 'en', '土耳其'),
  _m('希腊', 'GRC', REGIONS.EUROPE, 'Ekathimerini', 'https://www.ekathimerini.com/rss', 'en', '希腊'),
  _m('罗马尼亚', 'ROU', REGIONS.EUROPE, 'Romania Insider', 'https://www.romania-insider.com/rss', 'en', '罗马尼亚'),
  _m('匈牙利', 'HUN', REGIONS.EUROPE, 'Hungary Today', 'https://hungarytoday.hu/feed/', 'en', '匈牙利'),
  _m('捷克', 'CZE', REGIONS.EUROPE, 'Prague Morning', 'https://www.praguemorning.cz/feed/', 'en', '捷克'),
  _m('孟加拉国', 'BGD', REGIONS.SOUTH_ASIA, 'Prothom Alo', 'https://en.prothomalo.com/feed', 'en', '孟加拉国'),
  _m('斯里兰卡', 'LKA', REGIONS.SOUTH_ASIA, 'Daily Mirror', 'https://www.dailymirror.lk/rss', 'en', '斯里兰卡'),
  _m('哈萨克斯坦', 'KAZ', REGIONS.CENTRAL_ASIA, 'Astana Times', 'https://astanatimes.com/feed/', 'en', '哈萨克斯坦'),
  _m('伊朗', 'IRN', REGIONS.MIDDLE_EAST, 'Iran International', 'https://www.iranintl.com/en/feed', 'en', '伊朗'),
