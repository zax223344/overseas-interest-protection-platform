...
PASS = 'Test123456!'
OUT = r'C:\Users\28737\Desktop\新建文件夹\_screenshot_situation.png'
...
def main():
    ...
    with sync_playwright() as p:
        ...
        # situation is default view
        page.wait_for_selector('#globe-intel-live', timeout=20000)
        page.wait_for_timeout(2000)
        page.screenshot(path=OUT, full_page=False)
        print('screenshot saved', OUT)
        live = page.query_selector('#globe-intel-live')
        if live:
            print('panel text:', live.inner_text().replace('\n', ' | ')[:800])
        browser.close()
    if errors:
        print('--- errors ---')
