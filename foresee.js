...
(function () {
   ...
   * 分类体系 v2.0（#627）：types 补齐 18 子类新 key，旧 key 保留兼容（迁移后为空）。 */
  var DIMS8 = [
    { key: 'security', name: '安全', icon: '🛡️', types: ['terror_events', 'security_events', 'military_conflicts', 'mass_violence', 'crime_events'] },
    { key: 'political', name: '政治', icon: '🏛️', types: ['political_events', 'regime_change', 'election_events', 'policy_shift'] },
    { key: 'economic', name: '经济', icon: '💰', types: ['sanctions_data', 'economic_risk', 'financial_market', 'business_climate'] },
    { key: 'legal', name: '法律合规', icon: '⚖️', types: ['legal_compliance', 'sanctions_data', 'business_climate'] },
    { key: 'social', name: '社会', icon: '👥', types: ['social_unrest', 'public_health', 'cyber_security', 'industrial_accident', 'environmental_event'] },
  ...
  var TYPE_LABEL = (function(){ var m = { terror_events: '恐怖袭击', security_events: '安全事件', military_conflicts: '武装冲突', political_events: '政治动荡', natural_disasters: '自然灾害', public_health: '公共卫生', sanctions_data: '制裁合规', economic_risk: '经济风险', legal_compliance: '法律合规', social_unrest: '社会动荡', infrastructure: '基础设施', geopolitical_intel: '地缘情报', osint_intel: '开源情报' }; if (typeof CATV2 !== 'undefined' && CATV2.labelOf) { for (var k in CATV2.labelOf) m[k] = CATV2.labelOf[k]; } return m; })();
